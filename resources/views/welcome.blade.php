...
<html lang="en">
    <head>
        ...
        <link href="{{ asset('asset-homes/css/styles.css') }}" rel="stylesheet" />
    </head>
    <body id="page-top">
        <!-- Navigation-->
        <nav class="navbar navbar-expand-lg navbar-light fixed-top shadow-sm" id="mainNav">
            <div class="container px-5">
                <a class="navbar-brand fw-bold" href="#page-top">Cakrawala</a>
                            ...
                            <div class="device-wrapper">
                                <div class="device" data-device="iPhoneX" data-orientation="portrait" data-color="black">
                                    <div class="screen bg-black">
                                        <video muted="muted" autoplay="" loop="" style="max-width: 100%; height: 100%"><source src="{{ asset('asset-homes/assets/img/demo-screen.mp4') }}" type="video/mp4" /></video>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <footer class="bg-black text-center py-5">
            <div class="container px-5">
                <div class="text-white-50 small">
                    <div class="mb-2">&copy; Cakrawala 2023. All Rights Reserved.</div>
                    <a href="#!">Privacy</a>
        ...
        <script src="{{ asset('asset-home/js/scripts.js') }}"></script>
