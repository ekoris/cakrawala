...
<div class="row">
    <div class="col-lg-8 mt-5">
        <div class="card">
            <div class="card-body">
                <form method="POST" action="{{ route('admin.master-banner.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row mb-3">
                        <label for="name" class="col-md-4 col-form-label text-md-end">Nama Banner</label>
                        <div class="col-md-8">
                            <input type="text" placeholder="inputkan Nama Banner" class="form-control 
                            @error('name') 
                                is-invalid 
