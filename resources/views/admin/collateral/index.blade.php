            ...
            <div class="card-body">
                <form action="">
                    <div class="d-flex justify-content-end" style="padding-bottom: 15px">
                        <div class="mr-auto ">
                            <a class="btn btn-dark ms-2" href="{{ route('admin.master-collateral.create') }}">
                                Tambah
                            </a>
                        </div>
                        <div class="">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                <a href="{{ route('admin.master-collateral.edit', $item->id) }}" title="Edit">
                                                    <button type="button" class="btn btn-sm btn-outline-info"><i class="fa fa-pencil"></i></button>
                                                </a>
                                                <a href="{{ route('admin.master-collateral.delete', $item->id) }}" title="Hapus">
